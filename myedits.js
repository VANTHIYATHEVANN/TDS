...
import { Avatar, Button, Dialog, Typography, TextField, DialogContent } from "@material-ui/core";
...
const SeatSelectionDialog = ({ selectedShow, updateShowsRevenue, open, onClose }) => {
    ...
    return (
        <>
            <Dialog open={open} onClose={handleClose} fullWidth classes={{ paper: classes.dialogRoot }}>
                <div className={classes.container}>
                    <Typography variant="h6" className={classes.dialogHeader}>
                        <span style={{ flex: 1 }}>Select Seats</span>
                    ...
                    <div className={classes.dialogContent}>
                        ...
                        <Dialog open={buttonopen} onClose={handleButtonClose}>
                            <h2 align="center">
                                <span style={{ flex: 1 }}>{selectedShow.movie.name}</span>
                                <button onClick={handleButtonClose}>&#10005;</button>
                            </h2>
                            <DialogContent>
